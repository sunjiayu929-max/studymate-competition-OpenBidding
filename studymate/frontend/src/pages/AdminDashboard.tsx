...
function RoleBadge({ role }: { role: string }) { const labels: Record<string, string> = { admin: "系统管理员", enterprise_admin: "企业管理员", judge: "评委", student: "学习者", worker: "从业者" }; return <span className="rounded-full bg-[#E7EDF3] px-2 py-1 text-[10px] font-bold text-[#315E83]">{labels[role] || role}</span> }
