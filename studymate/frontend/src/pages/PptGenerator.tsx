      ...
      <div className="mx-auto max-w-[1540px] px-3 py-3 sm:px-5 sm:py-5 lg:px-7">
        ...
        <main className="mt-4 overflow-hidden rounded-[28px] border border-[#CFC8B9] bg-[#FFFEFA] shadow-[0_16px_42px_rgba(24,35,45,.07)]">
          ...
          <section className="grid gap-3 border-b border-[#D7D1C4] p-4 sm:grid-cols-2 lg:grid-cols-[minmax(220px,1.4fr)_repeat(4,minmax(130px,.65fr))_auto] sm:p-5">
            ...
            <button type="button" onClick={() => void generateOutline(false)} disabled={!topic.trim() || generating} className="mt-auto inline-flex h-10 items-center justify-center gap-1.5 rounded-xl bg-[#244C66] px-4 text-[10px] font-bold text-white disabled:opacity-40">{generating ? <Loader2 className="size-3.5 animate-spin" /> : <Sparkles className="size-3.5" />}使用所选模型生成</button>
