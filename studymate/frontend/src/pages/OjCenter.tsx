          ...
          <div className="border-b border-[#D7D1C4] bg-[#F8F6F0] px-5 py-6 sm:px-8">
            <div className="flex max-w-3xl items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-[#66717B]">在 StudyMate 内置的在线判题系统中完成算法与编程练习，提交后实时查看评测结果。</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-5 p-5 sm:p-8 lg:grid-cols-[minmax(0,1fr)_320px]">
            <section className="rounded-2xl border border-[#D7D1C4] bg-[#FBF9F4] p-5" aria-labelledby="oj-start">
              ...
              <dl className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-xl border border-[#E0DACE] bg-[#FFFEFA] p-3"><dt className="text-[10px] font-bold text-[#8A8172]">账号体系</dt><dd className="mt-1 text-sm font-bold text-[#315E83]">与 StudyMate 账号互通，自动登录</dd></div>
              </dl>
              <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:items-center">
                ...
                <span className="text-[10px] leading-4 text-[#8A8172]">将自动使用当前 StudyMate 账号登录在线判题系统，无需再次注册或登录。</span>
              </div>
            </section>

            <aside className="space-y-3" aria-label="在线评测说明">
              <div className="rounded-2xl border border-[#D7D1C4] bg-[#F8F6F0] p-4"><ShieldCheck className="size-5 text-[#6F8A69]" /><h2 className="mt-3 text-sm font-bold text-[#18232D]">账号说明</h2><p className="mt-1.5 text-xs leading-5 text-[#66717B]">首次进入时会根据当前 StudyMate 账号自动创建对应的判题系统账号，无需注册第二套账号。</p></div>
