...
const PAGE_ACTIONS: Partial<Record<PageId, Array<{ label: string; to: string }>>> = {
  home: [{ label: "课程空间", to: "/courses" }, { label: "学习工坊", to: "/workspace" }, { label: "学习画像", to: "/profile" }],
  workspace: [{ label: "课程上下文", to: "/courses" }, { label: "沉淀笔记", to: "/notes" }, { label: "验证掌握", to: "/quiz" }, { label: "查看报告", to: "/report" }],
  tutor: [{ label: "实时语音", to: "/tutor/voice" }, { label: "可视讲解", to: "/concept" }, { label: "学习画像", to: "/profile" }],
  profile: [{ label: "选择课程", to: "/courses" }, { label: "开始对话", to: "/tutor" }, { label: "查看报告", to: "/report" }],
  rag: [{ label: "自建知识库", to: "/knowledge" }, { label: "智能笔记", to: "/notes" }, { label: "AI 助教", to: "/tutor" }],
  knowledge: [{ label: "课程知识库", to: "/rag" }, { label: "上传资料", to: "/knowledge" }, { label: "检索结果", to: "/rag" }],
  ppt: [{ label: "学习工坊", to: "/workspace" }, { label: "课程知识库", to: "/rag" }, { label: "保存笔记", to: "/notes" }],
  resources: [{ label: "职业探索", to: "/career" }, { label: "课程空间", to: "/courses" }, { label: "学习报告", to: "/report" }],
  career: [{ label: "学习画像", to: "/profile" }, { label: "学习报告", to: "/report" }, { label: "课程空间", to: "/courses" }],
  ...
  quiz: [{ label: "课程空间", to: "/courses" }, { label: "智能笔记", to: "/notes" }, { label: "查看报告", to: "/report" }],
  ...
  guide: [{ label: "选择课程", to: "/courses" }, { label: "学习工坊", to: "/workspace" }, { label: "反馈中心", to: "/feedback" }],
    ...
    >
      <div className="app-topbar-main flex min-h-10 items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <h1 className="truncate text-[14px] font-bold tracking-[-.025em] text-[#17233D]">{meta.label}</h1>
        </div>
        <Link
          to="/courses"
          className={cn(
      ...
      <nav className="app-topbar-nav mt-2 flex items-center gap-1 overflow-x-auto border-t border-[#E7EEF7] pt-2" aria-label={`${meta.label}快捷操作`}>
