...
_ROLE_COURSES = [
    ...
    _role_course("MES工程师", "MES 岗位训练助理，优先依据已导入资料说明生产执行、系统集成、追溯与运维", "pseudo", ["SQL", "REST API", "OPC UA", "MES"], ["MES配置", "ERP 与 MES 集成", "生产追溯", "设备数据采集"], ["MES 如何实现生产追溯？", "ERP 与 MES 接口异常如何排查？"], "MES 配置 / 业务流程 / 系统集成 / 设备接入 / 追溯与运维"),
    _role_course("多模态大模型算法工程师", "多模态算法岗位训练助理，优先依据已导入资料说明数据、模型、训练和评测部署", "ml", ["Python", "PyTorch", "Transformers", "OpenCV"], ["多模态数据", "视觉语言模型", "模型训练", "评测部署"], ["如何构建多模态训练数据？", "视觉语言模型如何做工业场景评测？"], "多模态数据 / 特征表示 / 模型训练 / 评测 / 部署优化"),
    _role_course("工业 AI Agent应用工程师", "工业 AI Agent 岗位训练助理，优先依据已导入资料说明知识库、工作流、工具调用和安全评测", "pseudo", ["Python", "LLM API", "RAG", "Agent 工作流"], ["工业知识库", "Agent工作流", "工具调用", "安全评测"], ["工业 Agent 如何设计工具调用？", "如何评测工业知识问答的可靠性？"], "工业知识接入 / RAG / Agent 编排 / 工具调用 / 评测与治理"),
    _role_course("智能制造工程师（软件）", "智能制造软件岗位训练助理，优先依据已导入资料说明工业软件、云边协同、数据集成与交付", "pseudo", ["Python", "SQL", "Docker", "工业协议"], ["工业软件", "云边协同", "数据集成", "交付验证"], ["智能制造系统如何划分云边端职责？", "工业数据集成如何验收？"], "需求分析 / 工业软件架构 / 云边协同 / 数据集成 / 交付验证"),
    _role_course("物联网专项开发", "物联网开发岗位训练助理，优先依据已导入资料说明设备接入、工业协议、边缘开发与运维", "pseudo", ["Python", "MQTT", "OPC UA", "Docker"], ["物联网协议", "设备接入", "边缘开发", "联调运维"], ["设备接入失败如何定位？", "MQTT 与 OPC UA 如何选择？"], "设备感知 / 工业协议 / 边缘应用 / 数据传输 / 联调与运维"),
]
