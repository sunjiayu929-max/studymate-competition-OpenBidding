...
因材智训是面向高校计算机类课程的个性化学习平台，将学习画像、课程知识库、多智能体资源生成、AI 助教、智能测验、学习报告、可视化讲解和就业能力建议连接成完整学习闭环。
...
- 课程 RAG：内置 5 门基础课程、1709 个知识块及检索向量，支持混合检索和原文追溯。
- AI 课程助教：支持课程上下文、持续会话、图片与文件附件、流式回复。
- 学习闭环：课程空间、笔记、错题、测验、报告、画像回写、反馈与学习记录。
- 实时学习指挥舱：登录首屏用平台能力、个人真实学习数据、七颗能力星球与 7 Agents store 状态呈现完整学习闭环，进入后继续使用暖白今日学习桌面。
...
- 独立在线判题：通过因材智训入口进入 Hydro OJ；题库、提交记录、MongoDB 和 HydroJudge 保持独立部署。
